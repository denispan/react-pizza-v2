...
function Search() {
  ...
  return (
    <form className={styles.searchForm}>
      <input onChange={(evt => setSearchValue(evt.target.value))} className={styles.searchForm__input} placeholder='Поиск пицц...' value={searchValue}/>
      ...
      {
        searchValue &&
        <button onClick={() => setSearchValue('')} className={styles.searchForm__button} type="button">
